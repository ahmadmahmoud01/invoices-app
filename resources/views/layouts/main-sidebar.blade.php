				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('invoices.partiallyPaid') }}">الفواتير المدفوعة جزئيا</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('invoices.reports') }}">تقارير الفواتير</a></li>
							<li><a class="slide-item" href="{{ route('customers.reports') }}">تقارير العملاء</a></li>
						</ul>
					</li>
