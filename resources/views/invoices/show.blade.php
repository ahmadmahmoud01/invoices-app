                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($invoice->invoiceDetails as $invoiceDetails)
                                                            <tr>
                                                                ...
                                                                <td>{{ $invoice->section->section_name }}</td>
                                                                @if ($invoiceDetails->status_value == 1)
                                                                    <td>
                                                                        <span class="badge badge-pill badge-success">{{ $invoiceDetails->status }}</span>
                                                                    </td>
                                                                @elseif($invoiceDetails->status_value == 2)
                                                                    <td><span class="badge badge-pill badge-danger">{{ $invoiceDetails->status }}</span>
                                                                    </td>
                                                                @else
                                                                    <td><span class="badge badge-pill badge-warning">{{ $invoiceDetails->status }}</span>
                                                                    </td>
                                                                @endif
                                            ...
                                            <div class="card card-statistics">
                                                ...
                                                <div class="table-responsive mt-15">
                                                    <table class="table center-aligned-table mb-0 table table-hover"
                                                        ...
                                                        <tbody>
                                                            {{-- @if(count($invoice->invoiceAttachments) > 0) --}}
                                                                @foreach ($invoice->invoiceAttachments as $invoiceAttachment)
                                                                    <tr>
                                                                        <td>{{ $loop->iteration }}</td>
                                                                        ...
                                                                        <td colspan="2">
                                                                            ...
                                                                            <a class="btn btn-outline-success btn-sm"
                                                                                href="{{ route('file.view', [$invoice->invoice_number, $invoiceAttachment->file_name]) }}" role="button">
                                                                                <i class="fas fa-eye"></i>&nbsp; عرض</a>

                                                                            <a class="btn btn-outline-info btn-sm"
                                                                                href="{{ route('file.download', [$invoice->invoice_number, $invoiceAttachment->file_name])}}" role="button"><i
                                                                            ...
                                                                            {{-- @can('حذف المرفق') --}}
                                                                                <button class="btn btn-outline-danger btn-sm"
                                                                                    ...
                                                                                    data-file_id="{{ $invoiceAttachment->id }}"
    ...
    @if(count($invoice->invoiceAttachments) > 0)
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('invoices-attachments.destroy', $invoice->invoiceAttachments->first()) }}" method="post">
